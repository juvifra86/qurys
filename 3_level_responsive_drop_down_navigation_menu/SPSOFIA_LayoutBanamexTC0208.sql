...
[SPSOFIA_LayoutBanamexTC0208] '20160801','20160801',1,2,1,'pruebactbursa2.BCA',1,2      
...
ALTER Procedure [dbo].[SPSOFIA_LayoutBanamexTC0208]                                
       ...
       boleta integer                                      
			...
			join TipoProd TP on TP.TipoProdKey = P.TipoProdId                                       
			 ...
			 --and cb.BursatilDomi = @bursatil           
			  ...
			  and bcc.CuentaCteId not in(8616)    
