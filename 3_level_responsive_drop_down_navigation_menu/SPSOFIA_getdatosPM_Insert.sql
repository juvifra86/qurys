...
exec SPSOFIA_getdatosPM_Insert  1,'20160729',5                        
*/                                
ALTER procedure SPSOFIA_getdatosPM_Insert                                
@EmpresaID integer,                                    
@Periodo Date, ---Fecha              
...
Select                                  
  ...
  case when cast(d.UltimaFechaPago AS DATE) > cast(@fechafin as date) then      
   ...
   End)[UltimaFechaPago]                                         
    ...
    ,space(1)[Especial]   
	,c.Importe '23_Crédito Máximo Autorizado' -- Crédito Máximo Autorizado (agregado)                                  
     ,space(107)[FillerCR]   
